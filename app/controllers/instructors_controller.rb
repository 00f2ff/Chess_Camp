class InstructorsController < ApplicationController
  ...
  def edit
    ...
    # only build a user if it doesn't exist yet
  ...
  private
    ...
    def instructor_params
      params.require(:instructor).permit(:picture, :first_name, :last_name, :bio, :email, :phone, :active, user_attributes: [:id, :username, :password, :password_confirmation, :role, :active])
    end
end
